...
public class CircleProgressBar extends View {
	...
	public CircleProgressBar(Context context, AttributeSet attrs, int defStyle) {
		...
		// 获取自定义属性和默认值
		roundColor = mTypedArray.getColor(R.styleable.CircleProgressBar_roundColor, Color.parseColor("#CCCCCC"));
		roundProgressColor = mTypedArray.getColor(R.styleable.CircleProgressBar_roundProgressColor, Color.parseColor("#545454"));
		textColor = mTypedArray.getColor(R.styleable.CircleProgressBar_textColor, Color.parseColor("#545454"));
		textSize = mTypedArray.getDimension(R.styleable.CircleProgressBar_textSize, 15);
		roundWidth = mTypedArray.getDimension(R.styleable.CircleProgressBar_roundWidth, 10);
