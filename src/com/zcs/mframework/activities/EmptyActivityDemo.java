...
public class EmptyActivityDemo extends BaseActivity {
	private static final String CURR_TITLE = "Set Title Here";// 标题
	private static final String CURR_HIGH_WORD = "Title";// 标题高亮词
